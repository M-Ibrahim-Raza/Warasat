...
const SpouseNodes = ({spouseData}) => {
  ...
  useEffect(() => {
    ...
    const root = d3.hierarchy(spouseData);
    treeLayout(root);
    ...
    const svg = d3.select(svgRef.current)
      ...
      .attr("height", height);
        ...
        svg.selectAll('.link')
          ...
          .attr('y1', d => d.source.y + 45)
          .attr('x2', d => d.target.x-180)
          .attr('y2', d => {
            return d.target.y - 355
          })
          .attr('stroke', '#ccc')
          .attr('stroke-width', 2);
        ...
        const nodes = svg.selectAll('.node')
          ...
          .attr('transform', d => {
            if (d.data.name === "Deceased") {
              ...
              return `translate(${d.x - 200},${d.y - 380})`
            }
          });
