...
const parent_heirs_grouped = [[parent_heirs[0], parent_heirs[1], parent_heirs[4]],
...
const children_heirs_grouped = [[children_heirs[0], children_heirs[2], children_heirs[4]],
...
export { heirs, common_heirs, parent_heirs, children_heirs_grouped, sibling_heirs, spouse_heir, heir_types, parent_heirs_grouped };